    ...
    <main class="md:pl-20 pt-16">
        ...
        <section id="hero" class="relative min-h-screen flex items-center justify-center overflow-hidden">
            ...
            <div class="absolute inset-0 overflow-hidden">
                ...
                <div
                    class="absolute top-40 right-20 w-32 h-32 bg-[#1A4FD3]/20 rounded-full opacity-20 animate-float-delay">
                </div>
                <div
                    class="absolute bottom-40 left-1/4 w-16 h-16 bg-[#4A84F7]/20 rounded-full opacity-20 animate-float">
                </div>
                <div
                    class="absolute bottom-20 right-1/3 w-24 h-24 bg-[#DDE3E8] rounded-full opacity-60 animate-float-delay">
                </div>
            </div>
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="mb-8">
                        <h1 class="text-6xl md:text-8xl font-black mb-6">
                            Tu <span class="gradient-text">talento</span><br>
                            merece una <span class="gradient-text">beca</span>
                        </h1>
        ...
        <section id="becas" class="py-20 bg-white">
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    <h2 class="text-5xl md:text-6xl font-black mb-6">Encuentra tu <span class="gradient-text">beca
                            ideal</span></h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    @forelse($becas as $b)
                        <div
                            class="scholarship-card bg-gradient-to-br from-[#DDE3E8] to-white rounded-3xl p-8 border border-[#DDE3E8] relative overflow-hidden">
            ...
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    <h2 class="text-5xl font-black mb-6">
                        Nuestros <span class="gradient-text">beneficiarios</span>
                    </h2>
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                                ...
                                <tbody>
                                    @foreach($items as $row)
                                        <tr class="border-b border-gray-100 hover:bg-[#4A84F7]/10 transition-colors">
                                            <td class="p-4">
                                                <span class="font-semibold text-gray-800 text-justify">{{ $row->nombre }}</span>
                                            </td>
        ...
        <section id="proceso" class="py-20 bg-gradient-to-br from-[#00264B] to-[#1A4FD3] text-white">
            <div class="container mx-auto px-4">
                <div class="text-center mb-16">
                    <h2 class="text-5xl font-black mb-6">
                        Proceso <span class="text-[#E27227]">súper simple</span>
                    </h2>
                    <p class="text-xl text-[#DDE3E8] max-w-3xl mx-auto">
                        Solo {{ max(1, $procesos->count()) }} pasos para obtener tu beca y cambiar tu futuro
                    </p>
                </div>
        
                @if ($procesos->isEmpty())
                    <div class="max-w-4xl mx-auto text-center text-[#DDE3E8]">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                            @foreach ($procesos as $p)
                                <div class="text-center relative">
                                    <div
                                        class="bg-gradient-to-br from-[#1A4FD3] to-[#4A84F7] w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                                    ...
                                    @if (! $loop->last)
                                        <div
                                            class="hidden md:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-[#4A84F7] to-[#DDE3E8]/40">
                                        </div>
                                    @endif
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-4xl mx-auto text-center">
                    <h2 class="text-6xl md:text-8xl font-black mb-8">
                        Tu momento es <span class="text-[#E27227]">AHORA</span>
                    </h2>
