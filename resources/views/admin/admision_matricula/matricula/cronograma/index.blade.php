...
<head>
    ...
    <title>Cronograma de Matricula</title>
    ...
    <style>
        /* Cabecera fija en el contenedor scroll */
        .sticky-head th {
            position: sticky;
            top: 0;
            z-index: 2;
...
<body data-titulo="Registro de información sobre Cronograma de Matricula" class="has-sidebar">
            ...
            <div class="card roles-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="roles-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Gestionar información sobre Cronograma de Matricula</h5>
                            ...
                            <tbody>
                                @forelse($items as $row)
                                    <tr>
                                        ...
                                        <td class="text-center"><i class="{{ $row->icono }}"></i></td>
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-1 actions">
                                                ...
                                                <button class="btn btn-danger btn-sm btn-delete" title="Eliminar"
                                                    data-url="{{ route('matri-cronograma.destroy', ['cronograma' => $row->id]) }}"
        ...
        <div class="modal fade" id="modalNuevo" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('matri-cronograma.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="descripcion" rows="2" class="form-control @error('descripcion') is-invalid @enderror" required></textarea>
                                @error('descripcion')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                @error('icono')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Se guardará el valor (p. ej. <code>fa-solid fa-calendar</code>).</small>
                            </div>
                ...
                <div class="modal-content">
                    <form id="formEditar" action="#" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label" style="color:#2563eb;">Descripción *</label>
                                <textarea id="editDescripcion" name="descripcion" rows="2" class="form-control" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" style="color:#2563eb;">Icono *</label>
    ...
    <!-- js general -->
    @vite('resources/js/admin/admision_matricula/matricula/cronograma/matri-cronograma.js')
