...
<head>
    ...
    <title>Procesos de Matricula</title>
    ...
    <style>
        ...
        @media (min-width: 992px) { .truncate-text { max-width: 760px; } }
        @media (max-width: 991.98px) { .truncate-text { max-width: 320px; } }
...
<body data-titulo="Registro de información sobre Procesos de Matricula" class="has-sidebar">
            ...
            <div class="card roles-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="roles-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Procesos de Matricula</h5>
                        ...
                        <table class="table table-bordered content-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Nro de Paso</th>
                                    <th>Título</th>
                                    <th>Descripción</th>
                                    <th>Acciones</th>
                                </tr>
                            ...
                            <tbody>
                                @forelse($items as $row)
                                    <tr>
                                        ...
                                        <td class="text-center text-muted fw-semibold">{{ $row->numero_paso }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-1 actions">
                                                <button class="btn btn-warning btn-sm text-white btn-edit"
                                                    ...
                                                    data-numero="{{ $row->numero_paso }}"
                                                    data-titulo="{{ e($row->titulo) }}"
                                                    data-desc="{{ e($row->descripcion) }}"
                                                ...
                                                <button class="btn btn-danger btn-sm btn-delete"
                                                    title="Eliminar"
                                                    data-url="{{ route('matri-pasos.destroy', ['paso' => $row->id]) }}"
        ...
        <div class="modal fade" id="modalNuevo" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('matri-pasos.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="number" name="numero_paso" min="1" step="1"
                                    class="form-control @error('numero_paso') is-invalid @enderror"
                                    value="{{ old('numero_paso') }}" required>
                                @error('numero_paso')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="mb-3">
                ...
                <div class="modal-content">
                    <form id="formEditar" action="#" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label" style="color:#2563eb;">Nro de paso *</label>
                                <input type="number" id="editNumero" name="numero_paso" min="1" step="1" class="form-control" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label" style="color:#2563eb;">Título *</label>
    ...
    <!-- js general -->
    @vite('resources/js/admin/admision_matricula/matricula/proceso/matri-proceso.js')
