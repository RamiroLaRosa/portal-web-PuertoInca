...
<head>
    ...
    <title>Tipos de Matricula</title>
    ...
    <style>
        ...
        @media (min-width: 992px) { .truncate-text { max-width: 720px; } }
        @media (max-width: 991.98px) { .truncate-text { max-width: 320px; } }

        /* Acciones uniformes */
        .actions .btn, .actions .btn-icon {
...
<body data-titulo="Registro de información sobre Tipos de Matricula" class="has-sidebar">
            ...
            <div class="card roles-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="roles-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Registro de información sobre Tipos de Matricula</h5>
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <button class="btn btn-primary btn-pill btn-icon" type="button"
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-1 actions">
                                                ...
                                                <button class="btn btn-danger btn-sm btn-delete"
                                                    title="Eliminar"
                                                    data-url="{{ route('matri-tipos.destroy', $row) }}"
        ...
        <div class="modal fade" id="modalNuevo" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('matri-tipos.store') }}" method="POST">
                        @csrf <input type="hidden" name="_from" value="create">
                        <div class="modal-header">
                            <h5 class="modal-title" style="color:#2563eb;">Nuevo tipo de matrícula</h5>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form id="formEditar" action="#" method="POST">
                        @csrf @method('PUT')
                        <div class="modal-header">
                            <h5 class="modal-title" style="color:#2563eb;">Editar tipo de matrícula</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <div class="mb-3">
    ...
    <!-- js general -->
    @vite('resources/js/admin/admision_matricula/matricula/tipos/matri-tipos.js')
