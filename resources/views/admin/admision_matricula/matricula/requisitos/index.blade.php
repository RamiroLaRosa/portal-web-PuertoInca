...
<head>
    ...
    <title>Requisitos de Matricula</title>

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/hero.css') }}">
    <link rel="stylesheet" href="{{ asset('css/admin/admision_matricula/matricula/requisitos/requisitos.css') }}">
    ...
    <style>
        ...
        .matri-requisitos-table {
            table-layout: fixed;
        }

        .matri-requisitos-table th,
        .matri-requisitos-table td {
...
<body data-titulo="Registro de información sobre Requisitos de Matricula" class="has-sidebar">
            ...
            <div class="card roles-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="roles-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Registro de información sobre Requisitos de Matricula</h5>
                        ...
                        <table class="table table-bordered content-table">
                            ...
                            <tbody>
                                @forelse($items as $row)
                                    <tr>
                                        <td class="text-center">{{ $row->nro_paso ?? $row->id }}</td>

                                        <td class="text-muted fw-semibold">{{ $row->titulo }}</td>

                                        <td class="text-center">
                                            @if ($row->icono)
                                                <i class="{{ $row->icono }} fa-lg text-primary"
                                                    title="{{ $row->icono }}"></i>
                                            @else
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-1 actions">
                                                ...
                                                <button class="btn btn-danger btn-sm btn-delete" title="Eliminar"
                                                    data-url="{{ route('matri-requisitos.destroy', ['req' => $row->id]) }}"
                                                    data-title="{{ e($row->titulo) }}" data-bs-toggle="modal"
        ...
        <div class="modal fade" id="modalNuevo" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('matri-requisitos.store') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <input type="number" name="nro_paso"
                                    class="form-control @error('nro_paso') is-invalid @enderror"
                                    value="{{ old('nro_paso') }}" required min="1">
                                @error('nro_paso')
                ...
                <div class="modal-content">
                    <form id="formEditar" action="#" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label class="form-label" style="color:#2563eb;">Nro de Paso *</label>
                                <input type="number" id="editNroPaso" name="nro_paso" class="form-control" required
                                    min="1">
                            </div>
    ...
    @vite('resources/js/admin/admision_matricula/matricula/requisitos/matri-requisitos.js')
