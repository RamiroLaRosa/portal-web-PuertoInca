{{-- filepath: /C:/Users/SF-USER-02/Documents/GitHub/WEB-PUNO/Plantilla_IESTP/resources/views/admin/admision_matricula/admision/titulo/index.blade.php --}}
...
<head>
    ...
    <title>Titulo de Admisión</title>

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/hero.css') }}">
    <link rel="stylesheet" href="{{ asset('css/admin/admision_matricula/admision/titulo.css') }}">
</head>

<body data-titulo="Registro de información sobre Titulo" class="has-sidebar">
            ...
            <div class="card roles-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="roles-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Gestionar Información sobre Titulo</h5>
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <button class="btn btn-primary btn-new-role btn-pill btn-icon" type="button"
                                title="Nuevo registro" data-bs-toggle="modal" data-bs-target="#modalNuevo">
                                ...
                                @forelse($items as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span class="img-thumb btn-preview-img" data-src="{{ $row->imagen_url }}"
        ...
        <div class="modal fade" id="modalNuevo" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('admision-titulo.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <!-- js general -->
    @vite('resources/js/admin/admision_matricula/admision/titulo/titulo.js')
