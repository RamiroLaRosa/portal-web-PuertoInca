{{-- filepath: /C:/Users/SF-USER-02/Documents/GitHub/WEB-PUNO/Plantilla_IESTP/resources/views/admin/admision_matricula/admision/modalidades/index.blade.php --}}
...
<head>
    ...
    <title>Modalidades de Admisión</title>

    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/hero.css') }}">
    <link rel="stylesheet" href="{{ asset('css/admin/admision_matricula/admision/modalidades/modalidades.css') }}">
</head>

<body data-titulo="Registro de información sobre Modalidades de Admisión" class="has-sidebar">
            ...
            <div class="card roles-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="roles-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Gestionar información sobre Modalidades de Admisión</h5>
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-1">
                                                <button class="btn btn-warning btn-sm text-white btn-edit"
                                                    data-id="{{ $row->id }}" data-titulo="{{ e($row->titulo) }}"
                                                ...
                                                <button
                                                    ...
                                                    title="Eliminar"
                                                    data-url="{{ route('admin-modalidades.destroy', $row) }}"
                ...
                <div class="modal-content">
                    <form action="{{ route('admin-modalidades.store') }}" method="POST">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" style="color:#2563eb;">Nueva modalidad</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span id="createIconPreview" class="icon-preview text-primary"><i
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form id="formEditar" action="#" method="POST">
                        @csrf @method('PUT')
                        <div class="modal-header">
                            <h5 class="modal-title" style="color:#2563eb;">Editar modalidad</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span id="editIconPreview" class="icon-preview text-primary"><i
                                            class="fa-regular fa-circle-question"></i></span>
                                </div>
                            </div>
                            <div class="form-check form-switch">
                ...
                <div class="modal-content">
                    <form id="formEliminar" action="#" method="POST">
                        ...
                        <div class="modal-body" style="color:#2563eb;">
                            ¿Seguro que deseas eliminar <strong id="delTitulo">esta modalidad</strong>?
                        </div>
                        <div class="modal-footer">
    ...
    <!-- js general -->
    @vite('resources/js/admin/admision_matricula/admision/modalidades/modalidades.js')
