{{-- filepath: /C:/Users/SF-USER-02/Documents/GitHub/WEB-PUNO/Plantilla_IESTP/resources/views/admin/admision_matricula/admision/requisitos/index.blade.php --}}
...
<body data-titulo="Registro de información sobre Requisitos de Admisión" class="has-sidebar">
                ...
                <div class="modal-content">
                    <form id="formEliminar" action="#" method="POST">
                        ...
                        <div class="modal-body" style="color:#2563eb;">
                            ¿Seguro que deseas eliminar <strong id="delTitulo">este requisito</strong>?
                        </div>
                        <div class="modal-footer">
    ...
    <!-- js general -->
    @vite('resources/js/admin/admision_matricula/admision/requisitos/requisitos.js')
