...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/transparencia/licenciamiento/licenciamiento.css') }}">
</head>

<body data-titulo="Listado de Licenciamiento" class="has-sidebar">
            ...
            <div class="card content-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="content-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Registro de Licenciamiento</h5>
                                ...
                                @forelse($items as $row)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @php $doc = $row->documento; @endphp
                                            @if ($doc)
                                                <a class="pdf-thumb clickable" href="{{ asset($doc) }}"
                                                    target="_blank" title="Ver PDF">
                                                    <i class="fa-solid fa-file-pdf"></i>
                                                </a>
                                            @else
                                                <span class="pdf-thumb disabled" title="Sin documento">
                                                    <i class="fa-solid fa-file-pdf"></i>
                                                </span>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-1">
                                                ...
                                                <button class="btn btn-danger btn-sm btn-delete" title="Eliminar"
                                                    data-url="{{ route('licenciamiento.destroy', $row) }}"
                                                    data-title="{{ $row->nombre }}" data-bs-toggle="modal"
        ...
        <div class="modal fade" id="modalNuevo" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('licenciamiento.store') }}" method="POST" enctype="multipart/form-data">
    ...
    @vite('resources/js/admin/transparencia/licenciamiento/licenciamiento.js')
