...
<body data-titulo="Listado de Documentos de Gestión" class="has-sidebar">
                                        ...
                                        <td class="text-center">
                                            @if ($row->documento)
                                                <button type="button" class="btn btn-light pdf-open"
                                                    ...
                                                    <span class="pdf-thumb"><i class="fa-solid fa-file-pdf"></i></span>
                                                </button>
                                            @else
                                        ...
                                        <td class="text-center">
                                            <div class="d-inline-flex gap-1">
                                                ...
                                                <button class="btn btn-danger btn-sm btn-delete" title="Eliminar"
                                                        ...
                                                        data-delete-url="{{ route('documentos.destroy', $row) }}"
    ...
    @vite('resources/js/admin/transparencia/documentos/documentos_gestion.js')
