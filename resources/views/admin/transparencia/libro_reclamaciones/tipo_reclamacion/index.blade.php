...
<head>
    ...
    <title>Tipo de Reclamaciones</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/documentos.css') }}">
    <link rel="stylesheet" href="{{ asset('css/admin/transparencia/libro/tipo.css') }}">
    @vite('resources/css/darkmode.css')
</head>

<body data-titulo="Registro de información sobre Tipo de Reclamación" class="has-sidebar">
            ...
            <div class="card roles-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="roles-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Tipo de Reclamación</h5>
                    ...
                    <form id="formNuevo">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="monto" id="createMonto" class="form-control" required>
                            </div>
                ...
                <div class="modal-content">
                    <form id="formEditar">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label" style="color:#2563eb;">Descripción</label>
                                <input type="text" id="editMonto" name="monto" class="form-control" required>
                            </div>
                            <div class="form-check form-switch">
    ...
    @vite('resources/js/admin/transparencia/libro/tipo/tipo.js')
    ...
    <script>
        window.TIPO_RECLAMACION_ROUTES = {
            grid: "{{ route('tipo-reclamacion.grid') }}",
            store: "{{ route('tipo-reclamacion.store') }}",
            update: "{{ route('tipo-reclamacion.update', ':id') }}",
            destroy: "{{ route('tipo-reclamacion.destroy', ':id') }}"
        };
    </script>
</body>
