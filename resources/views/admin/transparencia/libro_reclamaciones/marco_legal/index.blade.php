...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/admin/transparencia/libro/marco.css') }}">
</head>

<body data-titulo="Registro de Marco del Libro de Reclamaciones" class="has-sidebar">
            ...
            <div class="card roles-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="roles-toolbar d-flex flex-wrap align-items-center justify-content-between gap-2 mb-3">
                        <h5 class="mb-0 fw-bold">Marco Legal</h5>
                    ...
                    <!-- Alertas (exclusivas del modo estático) -->
    ...
    @vite('resources/js/admin/transparencia/libro/marco/marco.js')
    ...
    <script>
        window.MARCO_ROUTES = {
            grid: "{{ route('marco-legal.grid') }}",
            store: "{{ route('marco-legal.store') }}",
            update: "{{ route('marco-legal.update', ':id') }}",
            destroy: "{{ route('marco-legal.destroy', ':id') }}"
        };
    </script>
</body>
