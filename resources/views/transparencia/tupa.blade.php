    ...
    <main class="md:pl-20">
        ...
        <section class="py-20 relative overflow-hidden">
            <div class="absolute inset-0 z-0">
                ...
                <div class="absolute top-1/4 right-1/4 w-64 h-64 rounded-full bg-[#1A4FD3]/20"></div>
                <div class="absolute bottom-1/3 left-1/3 w-80 h-80 rounded-full bg-[#4A84F7]/20"></div>
                <div class="absolute bottom-10 right-1/5 w-56 h-56 rounded-full bg-[#E27227]/15"></div>
            </div>
        ...
        <section class="py-20 bg-white">
            <div class="container mx-auto px-4 md:px-12">
                ...
                <div class="bg-white rounded-3xl shadow-lg overflow-hidden border border-gray-100">
                    <div class="overflow-x-auto">
                        <table class="w-full tupa-table" id="tupa-table">
                            <thead class="bg-[#00264B] text-white">
                                <tr>
                ...
                <div class="mt-12 bg-[#DDE3E8] rounded-3xl p-8">
                    <h3 class="text-2xl font-bold mb-6">Información Importante</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <h4 class="text-lg font-semibold mb-3 text-[#1A4FD3]">Formas de Pago</h4>
                        ...
                        <div>
                            <h4 class="text-lg font-semibold mb-3 text-[#1A4FD3]">Horarios de Atención</h4>
                            <ul class="space-y-2 text-gray-700">
