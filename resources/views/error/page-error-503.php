<!DOCTYPE html>
<?php require_once('../View/includes/directorios.php'); ?>
...
<!-- FAVICONS ICON -->
	<link rel="shortcut icon" type="image/png" href="<?php echo WEB_ROOT; ?>images/favicon.png" >
...
<body class="vh-100">    
   <div class="authincation h-100" style="background-image: url(<?php echo WEB_ROOT; ?>images/student-bg.jpg); background-repeat:no-repeat; background-size:cover;">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-lg-6 col-sm-12">
					<img  class="w-100" src="<?php echo WEB_ROOT; ?>images/svg/student.svg" alt="">
				</div>
            </div>
        </div>
    </div>
...
***********************************-->
<!-- Required vendors -->
<script src="<?php echo WEB_ROOT; ?>vendor/global/global.min.js"></script>
<script src="<?php echo WEB_ROOT; ?>js/custom.min.js"></script>
<script src="<?php echo WEB_ROOT; ?>js/dlabnav-init.js"></script>
